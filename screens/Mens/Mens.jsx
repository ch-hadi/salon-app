            ...
            <ImageBackground style={styles.imageStyle} source={image}>
              <View style={styles.bg_image_content}>
                ...
                <View style={styles.bannerContent}>
                  <Text style={{ color: "#fff" }}>FOR MEN</Text>
                  <View
                    style={{
                      width: "100%",
                      display: "flex",
                  ...
                  >
                    <View style={{ width: "70%" }}>
                      ...
                      <View style={styles.locationInfo}>
                        <Text style={styles.TextStyle}>Keira throughway</Text>
                        <Text
                          style={[
                            {
                              marginHorizontal: 10,
          ...
          >
            <View style={styles.content_view}>
              ...
              <View style={styles.reviews}>
                ...
                >
                  <Ionicons  name="star-outline" size="15px" color={"#629EF7"} />
                  <Text style={{ color: "#629EF7", fontWeight: "bold" }}>4.1</Text>
                </View>
                <Text style={{ marginTop: 5, color: "#629EF7" }}>5k + ratings</Text>
              </View>
            </View>
            <View style={{width:'100%', display:'flex', alignItems:'center'}}>
            <View style={{borderWidth:0.5,borderStyle:'dashed',borderColor:'#DCDBDB',width:'90%',height:1}}></View>
            </View>
